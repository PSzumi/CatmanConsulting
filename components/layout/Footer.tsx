                  ...
                  >
                    ...
                    <div className="relative flex items-center bg-white/5 border border-white/10 rounded-xl overflow-hidden">
                      ...
                      <motion.button
                        ...
                        className="px-4 py-3 bg-[#b8860b] text-white hover:bg-[#d4a843] transition-colors duration-300 disabled:opacity-50"
                ...
                <div className="flex items-center gap-2 mt-4">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-6 h-6 rounded-full bg-gradient-to-br from-[#b8860b] to-[#d4a843] border-2 border-[#0a0a0f] flex items-center justify-center"
                      >
