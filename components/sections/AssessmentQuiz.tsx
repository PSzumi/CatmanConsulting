...
import { DigitalBadge } from "@/components/ui/DigitalBadge";
...
export function AssessmentQuiz() {
  ...
  const { saveQuizResults } = useVisitorPersonalization();
  const { trackQuizStart, trackQuizComplete } = useLeadScoring();
  ...
  // Save quiz results for personalization and lead scoring
  useEffect(() => {
    if (showResult && result) {
      saveQuizResults(totalScore, result.level as "excellent" | "good" | "warning" | "critical");
      trackQuizComplete(totalScore);
    }
  }, [showResult, totalScore, result, saveQuizResults, trackQuizComplete]);
            ...
            {!showResult ? (
              ...
              >
                ...
                <DigitalBadge
                  ...
                  level={result.level as "excellent" | "good" | "warning" | "critical"}
