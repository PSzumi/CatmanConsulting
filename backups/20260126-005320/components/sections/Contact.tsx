...
function SuccessMessage() {
  return (
    ...
    >
      ...
      >
        Odezwiemy sie w ciagu 24 godzin roboczych.
      </motion.p>
      ...
      >
        <span className="text-sm text-gray-500">Porozmawiasz z:</span>
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Prowadzimy ograniczona liczbe projektow rocznie.
            <br />
            <span className="text-gray-500">
              Wstepna rozmowa pozwoli ocenic, czy nasze podejscie odpowiada Twoim potrzebom.
            </span>
          </p>
        </motion.div>
